...
namespace QQ.Framework.Domains.Commands.ResponseCommands.Login
{
    ...
    public class LoginVerifyCommand : ResponseCommand<Receive_0X0836>
    {
        ...
        public override void Process()
        {
            ...
            {
                _service.MessageLog("二次登录",MsgType.INFO);
            ...
            else if (_packet.Result == (byte) ResultCode.成功)
            {
                ...
                _service.MessageLog("登陆成功获取个人基本信息",MsgType.INFO);
                _service.MessageLog($"账号：{_user.QQ}，昵称：{_user.NickName}，年龄：{_user.Age}，性别：{_user.Gender}",MsgType.INFO);
